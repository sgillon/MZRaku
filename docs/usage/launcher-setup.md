...
Basic instructions for configuring popular emulation launchers to use MZRaku. This will be a work-in-progress.
...
- Assuming that you've set up MZRaku with the system ROM, font file and an S-BASIC .mzf, games can then be launched normally. The emulator will take care of working out whether to load BASIC or not before running the game.
